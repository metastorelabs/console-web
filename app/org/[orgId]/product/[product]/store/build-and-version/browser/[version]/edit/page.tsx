...
const VersionEdit = ({
  ...
  return (
    <div>
      ...
      <h1 className='text-white text-xl md:text-2xl font-semibold mt-4'>Edit version</h1>

      <p className='mt-1 text-sm leading-6 text-gray-400'>It won&apos;t be changed to users until you publish it.</p>

      <form>
        <div className='border-b border-white/10 pb-12 max-w-xl'>
