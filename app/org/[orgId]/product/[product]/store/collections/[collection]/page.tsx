        ...
        <div className='mt-5 flex lg:ml-4 lg:mt-0'>
          <span className='block'>
            <Link
              ...
              className='inline-flex items-center rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus-visible-ring'
            >
      ...
      <div className='border-b border-slate-800 pb-4 flex items-center justify-between mt-12'>
        ...
        <div className='mt-3 sm:ml-4 sm:mt-0'>
          <Link
            ...
            className='rounded-md bg-white/10 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-white/20 focus-visible-ring'
          >
            Create Item
          </Link>
        </div>
